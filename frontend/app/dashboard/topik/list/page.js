...
function MateriContent() {
  return (
    <div className="text-[15px] text-gray-700">
      ...
      <P>
        <strong>List</strong> (atau <em>sequence</em>) adalah sekumpulan elemen bertipe sama yang
        memiliki keterurutan tertentu (<em>ordered</em>, tidak harus <em>sorted</em>).
      </P>
      <P>
...
length = 5`}</AsciiBox>
      ...
      {/* ── 4. Ilustrasi ──────────────────────────────────────── */}
      <SectionHeading id="ilustrasi">Ilustrasi Insert dan Delete</SectionHeading>
      <P><strong>Insert 6 di awal:</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [6] [9] [5] [12] [7] [1]`}</AsciiBox>
      <P><strong>Insert 6 setelah indeks 1 (setelah angka 5):</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [9] [5] [6] [12] [7] [1]`}</AsciiBox>
      <P><strong>Insert 6 di akhir:</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [9] [5] [12] [7] [1] [6]`}</AsciiBox>
      <P><strong>Delete elemen pertama:</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [5] [12] [7] [1]`}</AsciiBox>
      <P><strong>Delete elemen di indeks 2 (angka 12):</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [9] [5] [7] [1]`}</AsciiBox>
      <P><strong>Delete elemen terakhir:</strong></P>
      <AsciiBox>{`Sebelum:  [9] [5] [12] [7] [1]
Sesudah:  [9] [5] [12] [7]`}</AsciiBox>
      ...
      <P>
        ADT List dapat diimplementasikan dengan dua cara: <strong>Array</strong> (elemen disimpan
        dalam array statik atau dinamis) atau <strong>Berkait</strong> (elemen disimpan dalam
        node-node yang saling terhubung). Materi ini fokus pada implementasi dengan{' '}
        <strong>array</strong>.
      </P>
      <P>Ada dua dimensi pilihan dalam implementasi array:</P>

      <SubHeading id="representasi">Representasi: Implisit (alt-1) vs Eksplisit (alt-2)</SubHeading>
      <P><strong>Implisit (alt-1)</strong> — elemen kosong ditandai dengan nilai khusus (mark):</P>
...
Traversal: while elemen ≠ MARK do ...`}</AsciiBox>
      <P><strong>Eksplisit (alt-2)</strong> — jumlah elemen efektif disimpan dalam variabel <Mono>nEff</Mono>:</P>
...
Traversal: for i = 0 to nEff-1 do ...`}</AsciiBox>
      ...
      <SubHeading id="posisi">Posisi Elemen: Rata Kiri (alt-a) vs Tidak Rata Kiri (alt-b)</SubHeading>
      <P><strong>Rata kiri (alt-a)</strong> — elemen selalu dimulai dari indeks 0:</P>
      <UL items={[
      ...
      <P><strong>Tidak rata kiri (alt-b)</strong> — elemen boleh dimulai dari indeks mana saja:</P>
      <UL items={[
      ...
      <SubHeading id="notasi-alt1a">Notasi Algoritmik: alt-1a (Implisit, Rata Kiri)</SubHeading>
...
{ Membentuk List kosong. Semua elemen diinisialisasi dengan MARK. }`}</Pseudocode>
      ...
      <SubHeading id="notasi-alt2a">Notasi Algoritmik: alt-2a (Eksplisit, Rata Kiri)</SubHeading>
      <Pseudocode>{`constant CAPACITY  : integer = 100
constant IDX_UNDEF : integer = -1
...
{ Membentuk List kosong. nEff diinisialisasi dengan 0. }`}</Pseudocode>
      ...
      {/* ── 7. Deklarasi ──────────────────────────────────────── */}
      <SectionHeading id="deklarasi">Deklarasi Selektor &amp; Operasi</SectionHeading>
...
{ Mengembalikan list hasil penggabungan l1 dan l2 (l2 di belakang l1). }`}</Pseudocode>
      ...
      <SubHeading id="contoh-length">Contoh Algoritma: <code className="font-mono text-[14px]">length</code></SubHeading>
      <P>Perbedaan efisiensi antara alt-1a dan alt-2a terlihat jelas di sini:</P>
      <P><strong>alt-1a (implisit):</strong></P>
...
→ i`}</Pseudocode>
      <P><strong>alt-2a (eksplisit):</strong></P>
      <Pseudocode>{`ALGORITMA
→ l.nEff`}</Pseudocode>
      <InfoBox>
        <p className="text-sm font-semibold text-purple-800 mb-1">Perbandingan Efisiensi</p>
        <p className="text-sm text-purple-700">
          alt-2a jauh lebih efisien: <strong>O(1)</strong> langsung mengembalikan <Mono>nEff</Mono>,
          sementara alt-1a membutuhkan <strong>O(n)</strong> traversal untuk menghitung elemen.
        </p>
      </InfoBox>

      <SubHeading id="contoh-insert">Contoh Algoritma: <code className="font-mono text-[14px]">insertAt</code></SubHeading>
      <P>
        Proses: geser semua elemen dari indeks <Mono>idx</Mono> ke kanan satu posisi, lalu isi posisi{' '}
        <Mono>idx</Mono> dengan <Mono>x</Mono>.
      </P>
      <P><strong>alt-1a:</strong></P>
      <Pseudocode>{`KAMUS LOKAL
i: integer
...
if length(l) < CAPACITY then
    ...
    l.nEff ← l.nEff + 1`}</Pseudocode>
      <NoteBox>
        Perbedaan utama: alt-2a perlu memperbarui <Mono>nEff</Mono> setiap kali ada insert atau delete.
      </NoteBox>
      <Divider />
...
{ true jika i adalah indeks efektif (firstIdx..lastIdx). }`}</Pseudocode>
      <W3Table
        ...
        rows={[
          ['insertFirst', 'O(n) — geser semua elemen ke kanan', 'O(1) — tulis di firstIdx−1'],
          ['deleteFirst', 'O(n) — geser semua elemen ke kiri', 'O(1) — majukan firstIdx'],
      ...
      <P>
        Array statik memiliki keterbatasan kapasitas tetap. Pada array dinamis, kapasitas bisa
...
ALGORITMA
    ...
    l.nEff ← 0`}</Pseudocode>
      ...
      <P><strong>Strategi Resize:</strong></P>
      <div className="my-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-[14px]">
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <p className="font-bold text-blue-800 mb-1">Array penuh — saat insert</p>
          <ul className="text-blue-700 text-sm space-y-1 list-disc list-inside">
            <li>Alokasi array baru ukuran <strong>2× kapasitas lama</strong></li>
            <li>Salin semua elemen ke array baru</li>
            <li>Lanjutkan insert</li>
          </ul>
        </div>
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4">
          <p className="font-bold text-orange-800 mb-1">Array terlalu kosong (≤25%) — setelah delete</p>
          <ul className="text-orange-700 text-sm space-y-1 list-disc list-inside">
            <li>Alokasi array baru ukuran <strong>0.5× kapasitas lama</strong></li>
            <li>Salin semua elemen ke array baru</li>
          </ul>
        </div>
      </div>
      <P>Dalam bahasa C, resize bisa menggunakan <Mono>realloc()</Mono>:</P>
...
if (baru != NULL) {
    ...
    l.capacity = newCapacity;
      ...
      <NoteBox>
        <Mono>realloc()</Mono> bisa gagal. Selalu periksa apakah hasilnya <Mono>NULL</Mono>.
      </NoteBox>
      <Divider />
...
Elemen digeser ke kiri agar kembali kontigu.`}</AsciiBox>
      ...
      <SectionHeading id="efisiensi">Perbandingan Efisiensi 5 Alternatif</SectionHeading>
      <W3Table
        headers={['Operasi', 'alt-1a', 'alt-2a', 'alt-1b', 'alt-2b', 'alt-3']}
        rows={[
          ['insertFirst', 'O(n) geser', 'O(n) geser', 'O(1)*', 'O(1)*', 'O(n) defragmen'],
      ...
      />
      <NoteBox>
        * alt-1a perlu traversal untuk mencari posisi akhir list terlebih dahulu.
        alt-1b dan alt-2b: O(1) jika masih ada ruang; O(n) jika harus defragmen.
      </NoteBox>

      <P><strong>Pola Traversal per alternatif:</strong></P>
  ...
  return (
    <div className="text-[15px] text-gray-700">
      ...
      <div className="mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-900">Memeriksa List Simetris</h2>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 leading-relaxed">
          <p>
            Diberikan definisi ADT List dengan representasi <strong>eksplisit, rata kiri</strong>{' '}
            (alt-2a). Buatlah fungsi{' '}
            <code className="bg-white border border-gray-200 text-purple-700 px-1 rounded font-mono text-[13px]">isSimetris</code>{' '}
            yang mengembalikan <code className="bg-white border border-gray-200 text-purple-700 px-1 rounded font-mono text-[13px]">true</code>{' '}
            jika list bersifat simetrik: elemen pertama sama dengan elemen terakhir, elemen kedua
            sama dengan elemen sebelum terakhir, dan seterusnya.
          </p>
      ...
      {/* Spesifikasi */}
      <div className="mb-5">
        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-2">Spesifikasi</h3>
      ...
      <div className="mb-5">
        ...
        {showHint && (
          <div className="mt-2 bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-3 text-sm text-gray-700">
            <p className="mb-2">
              Cukup bandingkan separuh elemen dari kiri dengan pasangannya dari kanan:
            </p>
            ...
            <p className="mt-2">
              Indeks tengah (jika length ganjil) tidak perlu diperiksa — selalu sama dengan dirinya sendiri.
            </p>
          </div>
        )}
      </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
                  <li>Inisialisasi <code className="font-mono">simetris ← true</code> dan <code className="font-mono">i ← 0</code></li>
                  <li>Loop selama <code className="font-mono">i {'<'} length(l) div 2</code> dan masih simetris</li>
                  <li>Bandingkan <code className="font-mono">getElmt(l, i)</code> dengan <code className="font-mono">getElmt(l, length(l)−1−i)</code></li>
                  <li>Jika berbeda, set <code className="font-mono">simetris ← false</code></li>
                  <li>Kembalikan <code className="font-mono">simetris</code></li>
                </ol>
              </div>
            </div>
...
ALGORITMA
    ...
    → simetris`}
            ...
            {/* Trace */}
            <div>
              <h3 className="text-base font-bold text-gray-800 mb-2">Trace untuk <code className="font-mono text-[14px]">[1, 2, 3, 2, 1]</code></h3>
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <W3Table
                  headers={['i', 'getElmt(l, i)', 'getElmt(l, 4-i)', 'Sama?', 'simetris']}
                  rows={[
                    ['0', '1', '1', 'Ya', 'true'],
                    ['1', '2', '2', 'Ya', 'true'],
            ...
            {/* Kasus khusus */}
            <div>
              <h3 className="text-base font-bold text-gray-800 mb-2">Kasus Khusus</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                  <p className="font-semibold text-green-800 mb-1">List kosong <code className="font-mono">[]</code></p>
                  <p className="text-green-700">
                    <code className="font-mono">length(l) = 0</code>, sehingga{' '}
                    <code className="font-mono">0 div 2 = 0</code>.<br />
                    Loop tidak dieksekusi → langsung <code className="font-mono">→ true</code>.
                  </p>
                </div>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="font-semibold text-blue-800 mb-1">List satu elemen <code className="font-mono">[5]</code></p>
      ...
      <div className="text-[15px] text-gray-700">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">ADT List — Implementasi Array</p>
          </div>
        </div>
  ...
  return (
    <div className="text-[15px] text-gray-700">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-500 mt-0.5">ADT List — Implementasi Array</p>
      </div>
        ...
        {!currentFeedback && (
          <div className="px-4 py-3">
            <textarea
              ...
              placeholder={soal.tipe === 'implementasi' ? '// Tulis algoritma atau kode kamu di sini...' : 'Tulis jawabanmu di sini...'}
...
function RingkasanContent() {
  return (
    <div className="text-[15px] text-gray-700">
      ...
      {/* ── Title ── */}
      <div className="mb-5">
        <h2 className="text-xl font-bold text-gray-900">Ringkasan — ADT List</h2>
        <p className="text-sm text-gray-400 mt-0.5">Implementasi List dengan Array</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 mb-6">
        ...
        <div className="border border-purple-100 rounded-xl overflow-hidden">
          <div className="bg-purple-600 px-4 py-2.5 flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm">Definisi &amp; Istilah</span>
          </div>
          <div className="px-4 py-3">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[13px]">
              {[
                { term: 'List',      def: 'Kumpulan elemen bertipe sama, terurut',     color: 'bg-purple-50 border-purple-100 text-purple-800' },
                { term: 'head',      def: 'Elemen pertama list',                        color: 'bg-indigo-50 border-indigo-100 text-indigo-800' },
                { term: 'length',    def: 'Jumlah elemen efektif',                      color: 'bg-blue-50 border-blue-100 text-blue-800' },
                { term: 'traversal', def: 'Kunjungi elemen satu per satu, ujung ke ujung', color: 'bg-teal-50 border-teal-100 text-teal-800' },
              ].map((item) => (
                <div key={item.term} className={`border rounded-lg px-3 py-2 ${item.color}`}>
                  <code className="font-mono font-bold text-[12px] block mb-0.5">{item.term}</code>
        ...
        <div className="border border-indigo-100 rounded-xl overflow-hidden">
          ...
          <div className="px-4 py-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[13px]">
              {[
                { group: 'Dasar',  ops: 'isEmpty, length, getElmt, setElmt, indexOf, concat',    color: 'bg-gray-50 border-gray-200 text-gray-700' },
                { group: 'Insert', ops: 'insertFirst, insertAt, insertLast',                      color: 'bg-green-50 border-green-100 text-green-800' },
                { group: 'Delete', ops: 'deleteFirst, deleteAt, deleteLast',                      color: 'bg-red-50 border-red-100 text-red-800' },
              ].map((item) => (
                <div key={item.group} className={`border rounded-lg px-3 py-2 ${item.color}`}>
                  <div className="font-bold mb-1">{item.group}</div>
                  <code className="text-[11px] font-mono opacity-80 leading-relaxed">{item.ops}</code>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="border border-blue-100 rounded-xl overflow-hidden">
          <div className="bg-blue-600 px-4 py-2.5 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-white text-blue-600 text-xs font-bold flex items-center justify-center shrink-0">3</span>
            <span className="text-white font-bold text-sm">5 Alternatif Implementasi</span>
          </div>
          <div className="px-4 py-3">
            <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 text-[12px]">
              {[
                { alt: 'alt-1a', rep: 'Implisit', pos: 'Rata kiri',     color: 'bg-gray-50 border-gray-200' },
                { alt: 'alt-2a', rep: 'Eksplisit', pos: 'Rata kiri',    color: 'bg-purple-50 border-purple-100' },
                { alt: 'alt-1b', rep: 'Implisit', pos: 'Tidak rata kiri', color: 'bg-blue-50 border-blue-100' },
                { alt: 'alt-2b', rep: 'Eksplisit', pos: 'Tidak rata kiri', color: 'bg-teal-50 border-teal-100' },
                { alt: 'alt-3',  rep: 'Implisit', pos: 'Tersebar',       color: 'bg-orange-50 border-orange-100' },
              ].map((item) => (
                <div key={item.alt} className={`border rounded-lg px-2 py-2 ${item.color} text-center`}>
                  <code className="font-mono font-bold text-[11px] block mb-0.5">{item.alt}</code>
        ...
        <div className="border border-teal-100 rounded-xl overflow-hidden">
          <div className="bg-teal-600 px-4 py-2.5 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-white text-teal-600 text-xs font-bold flex items-center justify-center shrink-0">4</span>
            <span className="text-white font-bold text-sm">Perbandingan Efisiensi Kunci</span>
          </div>
          <div className="px-4 py-3">
            <div className="grid grid-cols-1 gap-2 text-[13px]">
              {[
                { op: 'length', alt1: 'O(n) — traversal sampai MARK', alt2: 'O(1) — langsung nEff', winner: 'alt-2' },
                { op: 'insertFirst / deleteFirst', alt1: 'O(n) — geser semua elemen', altb: 'O(1) — geser pointer', winner: 'alt-b' },
                { op: 'delete (tanpa geser)', altx: 'O(1) — set MARK', note: 'alt-3', winner: 'alt-3' },
              ].map((item, i) => (
                <div key={i} className="border border-gray-200 rounded-lg px-3 py-2 bg-gray-50">
                  <code className="font-mono font-bold text-[12px] text-gray-800">{item.op}</code>
                  <div className="mt-1 grid grid-cols-2 gap-2 text-[11px]">
                    {item.alt1 && <div className="bg-red-50 border border-red-100 rounded px-2 py-1 text-red-700">alt-a: {item.alt1}</div>}
                    {item.alt2 && <div className="bg-green-50 border border-green-100 rounded px-2 py-1 text-green-700">alt-2: {item.alt2}</div>}
                    {item.altb && <div className="bg-green-50 border border-green-100 rounded px-2 py-1 text-green-700">alt-b: {item.altb}</div>}
                    {item.altx && <div className="bg-green-50 border border-green-100 rounded px-2 py-1 text-green-700 col-span-2">{item.note}: {item.altx}</div>}
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden">
          <div className="bg-gray-800 px-4 py-2.5 flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm">Pola Traversal per Alternatif</span>
          </div>
          <div className="px-4 py-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-[12px]">
              <div>
                <div className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alt-1 (implisit)</div>
...
while contents[i] ≠ MARK
    ...
    i ← i + 1`}</pre>
              ...
              <div>
                <div className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alt-2 (eksplisit)</div>
                <pre className="bg-gray-900 text-green-300 rounded-lg px-3 py-2 font-mono text-[11px] leading-relaxed">{`i traversal
    [0..l.nEff-1]
    { proses }`}</pre>
              </div>
              <div>
                <div className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alt-3 (tersebar)</div>
                <pre className="bg-gray-900 text-green-300 rounded-lg px-3 py-2 font-mono text-[11px] leading-relaxed">{`i traversal
    [0..CAPACITY-1]
    if ≠ MARK then
        { proses }`}</pre>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 mb-6">
        <p className="text-sm font-bold text-purple-800 mb-2">Aturan Praktis Memilih Alternatif</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-[12px]">
          <div className="bg-white border border-purple-100 rounded-lg px-3 py-2 text-purple-900">
            ...
            <div className="opacity-80">→ Gunakan <code className="font-mono">alt-2</code> (eksplisit)</div>
          </div>
          <div className="bg-white border border-purple-100 rounded-lg px-3 py-2 text-purple-900">
            <div className="font-bold mb-0.5">Sering insertFirst/deleteFirst?</div>
            <div className="opacity-80">→ Gunakan <code className="font-mono">alt-b</code> (tidak rata kiri)</div>
          </div>
          <div className="bg-white border border-purple-100 rounded-lg px-3 py-2 text-purple-900">
            <div className="font-bold mb-0.5">Sering delete acak, jarang insert?</div>
            <div className="opacity-80">→ Pertimbangkan <code className="font-mono">alt-3</code> (tersebar)</div>
          </div>
        </div>
      </div>
      ...
      <div className="border border-gray-200 rounded-xl p-4 bg-gray-50">
        <p className="text-sm font-bold text-gray-700 mb-3">Notasi Algoritmik — Referensi Cepat (alt-2a)</p>
