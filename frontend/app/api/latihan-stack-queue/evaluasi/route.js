  ...
  pengetahuan: [
    {
      ...
      maks: 40,
      panduan: 'Apakah konsep yang dijelaskan benar dan tepat secara teknis (prinsip FIFO/LIFO, kondisi kosong/penuh, perbedaan Alt-1/2/3, urutan pop pada postfix)?',
    },
    {
  ...
  implementasi: [
    {
      ...
      maks: 40,
      panduan: 'Apakah logika/algoritma benar? Apakah operasi Queue (enqueue/dequeue dengan benar mengelola HEAD/TAIL) atau Stack (push/pop mengelola TOP) diimplementasikan dengan benar? Untuk postfix: urutan pop operan sudah benar?',
    },
    {
      nama: 'Kelengkapan Notasi / Kode',
      maks: 25,
      panduan: 'Apakah semua bagian yang diminta ada dan lengkap (KAMUS LOKAL, inisialisasi, loop, kondisi terminasi, penanganan queue kosong/satu elemen, I.S./F.S. jika diminta)?',
    },
    {
    ...
    },
    {
      ...
      maks: 15,
      panduan: 'Apakah kasus tepi ditangani dengan benar (queue/stack kosong, queue/stack penuh, satu elemen, masalah semi-full pada Alt-2, stack underflow saat pop)?',
    },
  ],
};
...
Materi: Queue dan Stack — Queue (FIFO, HEAD/TAIL/IDX_UNDEF, Alt-1 geser semua O(n), Alt-2 HEAD bergerak masalah semi-full, Alt-3 circular buffer O(1)), implementasi C (queue.h, enqueue Alt-2 dengan geser balik, dequeue), Stack (LIFO, TOP/IDX_UNDEF, push idxTop++, pop idxTop--), implementasi C (stack.h), perbandingan Queue vs Stack, aplikasi postfix evaluation (baca token: operan→push, operator→pop dua operan→hitung→push, urutan pop: pop pertama=operan kedua), copyStack/inverseStack/mergeStack, round robin, priority queue.
