  ...
  if (tipe_paksa && jumlah === 1) {
    const tipeLabel =
      tipe_paksa === 'implementasi'
        ? '"implementasi" (wajib sertakan notasi algoritmik lengkap + implementasi bahasa C)'
    ...
    systemPrompt =
      ...
      'Cakupan materi: algoritma dasar, paradigma prosedural, ADT (Abstract Data Type), fungsi & prosedur, rekursi, pointer & pass-by-reference, modularitas C (.h/.c/main.c), notasi algoritmik IF2111.' +
      kelemahanCtx + '\n\n' +
      PANDUAN + '\n\n' +
