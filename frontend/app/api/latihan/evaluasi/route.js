const RUBRIK = {
  ...
  implementasi: [
    ...
    },
    {
      ...
      maks: 25,
      panduan: 'Apakah sintaks C digunakan dengan benar? Apakah tipe data, return type, dan deklarasi sudah tepat?',
    },
    {
    ...
    },
    {
      ...
      maks: 15,
      panduan: 'Apakah semua bagian yang diminta (fungsi, main, validasi, dll.) sudah diimplementasikan?',
    },
  ],
};
