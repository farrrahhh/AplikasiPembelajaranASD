  ...
  implementasi: [
    {
      ...
      maks: 40,
      panduan: 'Apakah logika/algoritma yang diimplementasikan benar dan menghasilkan output yang sesuai?',
    },
    {
      nama: 'Sintaks & Konvensi C',
      maks: 25,
      panduan: 'Apakah sintaks C digunakan dengan benar? Apakah tipe data, return type, pointer, dan macro selektor sudah tepat?',
    },
    {
      nama: 'Kesesuaian Notasi Algoritma',
      maks: 20,
      panduan: 'Apakah implementasi sesuai dengan notasi algoritma yang diberikan (jika ada)?',
    },
    {
      nama: 'Kelengkapan Implementasi',
      maks: 15,
      panduan: 'Apakah semua bagian yang diminta (fungsi, include, konstruktor, selektor, dll.) sudah diimplementasikan?',
    },
  ],
};
...
Materi: ADT Sederhana — definisi ADT, komponen ADT (konstruktor, selektor, predikat, operasi I/O, operasi lain), implementasi ADT POINT dalam bahasa C, macro preprocessor sebagai selektor, file .h dan .c, include guard, tipe boolean manual, kompilasi multi-file.
